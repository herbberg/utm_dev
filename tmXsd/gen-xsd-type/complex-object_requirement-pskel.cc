...
namespace tmxsd
{
  ...
  {
    this->comparison_operator_parser_ = &p;
  }
           ...
           ::tmxsd::datetime_pskel& datetime)
  {
    ...
    this->comparison_operator_parser_ = &comparison_operator;
    ...
    switch (state)
    {
      ...
      case 2UL:
      {
        if (n == "comparison_operator" && ns.empty ())
        {
          if (start)
          {
            this->::xml_schema::complex_content::context_.top ().parser_ = this->comparison_operator_parser_;

            if (this->comparison_operator_parser_)
              this->comparison_operator_parser_->pre ();
          }
          else
          {
            if (this->comparison_operator_parser_)
      ...
      case 3UL:
      {
        if (n == "threshold" && ns.empty ())
        {
          if (start)
          {
            this->::xml_schema::complex_content::context_.top ().parser_ = this->threshold_parser_;
