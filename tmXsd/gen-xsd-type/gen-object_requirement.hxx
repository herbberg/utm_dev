...
/**
 * @file
 * @brief Generated from object_requirement.xsd.
 */
...
#include "gen-xsd-type/complex-object_requirement.hxx"
...
{
  /**
   * @name Parsing functions for the %object_requirement document root.
   */
  //@{
...
{
  /**
   * @name Serialization functions for the %object_requirement document root.
   */
  //@{
   ...
   */
  void
  object_requirement_ (::std::ostream& os,
                       const ::tmxsdtree::object_requirement& x, 
   ...
   */
  void
  object_requirement_ (::xercesc::XMLFormatTarget& ft,
                       const ::tmxsdtree::object_requirement& x, 
                       const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                       const ::std::string& e = "UTF-8",
                       ::xml_schema::flags f = 0);
...
#endif // CXX___OBJECT_REQUIREMENT_HXX
