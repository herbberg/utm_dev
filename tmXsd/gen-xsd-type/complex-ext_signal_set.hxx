...
/**
 * @file
 * @brief Generated from complex-ext_signal_set.xsd.
 */
...
namespace tmxsdtree
{
   ...
   *
   * The ext_signal_set complex type holds information associated to
   * EXT_SIGNAL_SET table in the CMS level-1 trigger menu database
   *
   * @nosubgrouping
   */
  class ext_signal_set: public ::xml_schema::type
  {
     ...
     */
    void
    ext_signal_set_id (::std::unique_ptr< ext_signal_set_id_type > p);
