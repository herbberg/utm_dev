...
#ifndef CXX___XSD_TYPE_COMPLEX_SCALE_SET_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_SCALE_SET_PSKEL_HH
...
namespace tmxsd
{
  class scale_set_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    void
    scale_parser (::tmxsd::scale_pskel&);

    void
    scale_set_id_parser (::tmxsd::id_pskel&);
    ...
    ::tmxsd::scale_pskel* scale_;
    ::tmxsd::id_pskel* scale_set_id_;
    ...
    {
      void (::tmxsd::scale_set_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_SCALE_SET_PSKEL_HH
