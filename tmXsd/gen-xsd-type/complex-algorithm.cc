...
namespace tmxsdtree
{
  ...
  : ::xml_schema::type (),
    ...
    module_id_ (module_id, ::xml_schema::flags (), this),
    module_index_ (module_index, ::xml_schema::flags (), this),
    comment_ (::xml_schema::flags (), this),
    cut_ (::xml_schema::flags (), this),
    object_requirement_ (::xml_schema::flags (), this),
    external_requirement_ (::xml_schema::flags (), this),
    algorithm_id_ (::xml_schema::flags (), this),
  ...
  : ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
    ...
    index_ (f, this),
    module_id_ (f, this),
    module_index_ (f, this),
    comment_ (f, this),
    cut_ (f, this),
    object_requirement_ (f, this),
    external_requirement_ (f, this),
    algorithm_id_ (f, this),
    datetime_ (f, this)
  {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      if (n.name () == "module_id" && n.namespace_ ().empty ())
      {
        ...
        {
          this->module_id (module_id_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (n.name () == "module_index" && n.namespace_ ().empty ())
      {
        ...
        {
          this->module_index (module_index_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (n.name () == "object_requirement" && n.namespace_ ().empty ())
      {
        ...
        this->object_requirement ().push_back (r);
        continue;
      }
      ...
      if (n.name () == "external_requirement" && n.namespace_ ().empty ())
      {
        ...
        this->external_requirement ().push_back (r);
        continue;
      }
    ...
    while (p.more_attributes ())
    {
      ...
      {
        ::std::auto_ptr< algorithm_id_type > r (
          algorithm_id_traits::create (i, f, this));
