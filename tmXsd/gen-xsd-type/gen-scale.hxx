...
/**
 * @file
 * @brief Generated from ../scale.xsd.
 */

#ifndef CXX___SCALE_HXX
#define CXX___SCALE_HXX
...
#include "gen-xsd-type/complex-bin.hxx"

#include "gen-xsd-type/complex-scale.hxx"
...
{
  /**
   * @name Parsing functions for the %scale document root.
   */
  //@{
   ...
   */
  ::std::auto_ptr< ::tmxsdtree::scale >
  scale_ (const ::xercesc::DOMDocument& d,
          ::xml_schema::flags f = 0,
          const ::xml_schema::properties& p = ::xml_schema::properties ());
...
{
  /**
   * @name Serialization functions for the %scale document root.
   */
  //@{
   ...
   */
  void
  scale_ (::std::ostream& os,
          const ::tmxsdtree::scale& x, 
   ...
   */
  void
  scale_ (::xercesc::XMLFormatTarget& ft,
          const ::tmxsdtree::scale& x, 
          const ::xml_schema::namespace_infomap& m,
          const ::std::string& e = "UTF-8",
          ::xml_schema::flags f = 0);
  ...
  scale_ (const ::tmxsdtree::scale& x, 
          const ::xml_schema::namespace_infomap& m,
          ::xml_schema::flags f = 0);
