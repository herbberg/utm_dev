...
namespace tmxsd
{
  class ext_signal_set_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    void
    ext_signal_parser (::tmxsd::ext_signal_pskel&);

    void
    ext_signal_set_id_parser (::tmxsd::id_pskel&);
    ...
    ::tmxsd::ext_signal_pskel* ext_signal_;
    ::tmxsd::id_pskel* ext_signal_set_id_;
    ...
    {
      void (::tmxsd::ext_signal_set_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_SET_PSKEL_HH
