...
/**
 * @file
 * @brief Generated from complex-object_requirement.xsd.
 */
...
namespace tmxsdtree
{
  ...
  class object_requirement: public ::xml_schema::type
  {
     ...
     */
    void
    comparison_operator (::std::unique_ptr< comparison_operator_type > p);
     ...
     */
    void
    requirement_id (::std::unique_ptr< requirement_id_type > p);
