...
namespace tmxsdtree
{
  ...
  : ::xml_schema::type (),
    ...
    system_ (system, ::xml_schema::flags (), this),
    cable_ (cable, ::xml_schema::flags (), this),
    channel_ (channel, ::xml_schema::flags (), this),
    description_ (::xml_schema::flags (), this),
    label_ (::xml_schema::flags (), this),
    ext_signal_id_ (::xml_schema::flags (), this),
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      if (n.name () == "cable" && n.namespace_ ().empty ())
      {
        if (!cable_.present ())
        {
          this->cable (cable_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (n.name () == "channel" && n.namespace_ ().empty ())
      {
        if (!channel_.present ())
        {
          this->channel (channel_traits::create (i, f, this));
          continue;
        }
      }
    ...
    while (p.more_attributes ())
    {
      ...
      {
        ::std::auto_ptr< ext_signal_id_type > r (
          ext_signal_id_traits::create (i, f, this));

        this->ext_signal_id (r);
        continue;
      }
  ...
  {
    return new ext_signal (*this, f, c);
  }
