...
namespace tmxsd
{
           ...
           ::xml_schema::boolean_pskel& is_valid)
  {
    ...
    this->scale_ = &scale;
    this->scale_set_id_ = &scale_set_id;
    ...
    switch (state)
    {
      ...
      case 2UL:
      {
        if (n == "scale" && ns.empty ())
        {
          if (start)
          {
            this->::xml_schema::complex_content::context_.top ().parser_ = this->scale_;
          ...
          else
          {
            if (this->scale_)
            {
              const ::tmxsd::scale& tmp (this->scale_->post_scale ());
              this->scale (tmp);
            }
...
namespace tmxsd
{
                             ...
                             const ::xml_schema::ro_string& s)
  {
    ...
    {
      if (this->scale_set_id_)
      {
        this->scale_set_id_->pre ();
        this->scale_set_id_->_pre_impl ();
        this->scale_set_id_->_characters (s);
        this->scale_set_id_->_post_impl ();
        unsigned int tmp (this->scale_set_id_->post_id ());
