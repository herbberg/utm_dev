...
namespace tmxsdtree
{
  ...
  : ::xml_schema::type (),
    ...
    ext_signal_ (::xml_schema::flags (), this),
    ext_signal_set_id_ (::xml_schema::flags (), this),
         ...
         ::xml_schema::flags f)
  {
    ...
    while (p.more_attributes ())
    {
      ...
      {
        ::std::auto_ptr< ext_signal_set_id_type > r (
          ext_signal_set_id_traits::create (i, f, this));

        this->ext_signal_set_id (r);
        continue;
      }
  ...
  {
    return new ext_signal_set (*this, f, c);
  }
