...
/**
 * @file
 * @brief Generated from ../xsd-type/complex-bin.xsd.
 */

#ifndef CXX___XSD_TYPE_COMPLEX_BIN_HXX
#define CXX___XSD_TYPE_COMPLEX_BIN_HXX
...
{
  /**
   * @brief Class corresponding to the %bin schema type.
   *
   * The bin complex type holds information associated to ALGORITHM table in the CMS
   * level-1 trigger menu database
   *
   * @nosubgrouping
   */
  class bin: public ::xml_schema::type
  {
    public:
    /**
     * @name number
     ...
     * @brief Element type.
     */
    typedef ::xml_schema::unsigned_int number_type;
     ...
     * @name bin_id
     *
     * @brief Accessor and modifier functions for the %bin_id
     * optional attribute.
     */
    //@{
     ...
     */
    typedef ::tmxsdtree::id bin_id_type;

    /**
     * @brief Attribute optional container type.
     */
    typedef ::xsd::cxx::tree::optional< bin_id_type > bin_id_optional;

    /**
     * @brief Attribute traits type.
     */
    typedef ::xsd::cxx::tree::traits< bin_id_type, char > bin_id_traits;
     ...
     */
    void
    bin_id (::std::auto_ptr< bin_id_type > p);
...
{
  void
  operator<< (::xercesc::DOMElement&, const bin&);
}
...
#endif // CXX___XSD_TYPE_COMPLEX_BIN_HXX
