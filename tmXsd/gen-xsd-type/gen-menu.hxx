...
#ifndef CXX___MENU_HXX
#define CXX___MENU_HXX
...
#include "gen-xsd-type/complex-menu.hxx"
...
{
  /**
   * @name Serialization functions for the %menu document root.
   */
  //@{
   ...
   */
  void
  menu_ (::std::ostream& os,
         const ::tmxsdtree::menu& x, 
   ...
   */
  void
  menu_ (::xercesc::XMLFormatTarget& ft,
         const ::tmxsdtree::menu& x, 
         const ::xml_schema::namespace_infomap& m,
         const ::std::string& e = "UTF-8",
         ::xml_schema::flags f = 0);
