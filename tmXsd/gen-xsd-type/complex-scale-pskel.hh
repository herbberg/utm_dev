...
namespace tmxsd
{
  class scale_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    ::tmxsd::real_pskel* step_;
    ::xml_schema::unsigned_int_pskel* n_bits_;
    ::tmxsd::char4k_pskel* comment_;
    ::tmxsd::bin_pskel* bin_;
    ::tmxsd::id_pskel* scale_id_;
    ::tmxsd::datetime_pskel* datetime_;
    ::xml_schema::unsigned_int_pskel* n_bins_;
