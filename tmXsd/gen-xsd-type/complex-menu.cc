...
namespace tmxsdtree
{
  ...
  : ::xml_schema::type (),
    ancestor_id_ (ancestor_id, ::xml_schema::flags (), this),
    name_ (name, ::xml_schema::flags (), this),
    uuid_menu_ (uuid_menu, ::xml_schema::flags (), this),
    uuid_firmware_ (uuid_firmware, ::xml_schema::flags (), this),
    global_tag_ (global_tag, ::xml_schema::flags (), this),
    grammar_version_ (grammar_version, ::xml_schema::flags (), this),
    n_modules_ (n_modules, ::xml_schema::flags (), this),
    is_valid_ (::xml_schema::flags (), this),
    is_obsolete_ (::xml_schema::flags (), this),
    comment_ (::xml_schema::flags (), this),
    algorithm_ (::xml_schema::flags (), this),
    scale_set_ (::xml_schema::flags (), this),
    ext_signal_set_ (::xml_schema::flags (), this),
    menu_id_ (::xml_schema::flags (), this),
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      if (n.name () == "n_modules" && n.namespace_ ().empty ())
      {
        ...
        {
          this->n_modules (n_modules_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (n.name () == "is_obsolete" && n.namespace_ ().empty ())
      {
        if (!this->is_obsolete ())
        {
          this->is_obsolete (is_obsolete_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (n.name () == "ext_signal_set" && n.namespace_ ().empty ())
      {
        ...
        if (!this->ext_signal_set ())
        {
          this->ext_signal_set (r);
          continue;
        }
      }
    ...
    while (p.more_attributes ())
    {
      ...
      {
        ::std::auto_ptr< menu_id_type > r (
          menu_id_traits::create (i, f, this));
