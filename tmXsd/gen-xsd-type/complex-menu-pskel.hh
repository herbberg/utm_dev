...
#ifndef CXX___XSD_TYPE_COMPLEX_MENU_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_MENU_PSKEL_HH
...
namespace tmxsd
{
  class menu_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    //
    void
    ancestor_id_parser (::tmxsd::id_pskel&);

    void
    name_parser (::tmxsd::char1k_pskel&);

    void
    uuid_menu_parser (::tmxsd::uuid_pskel&);

    void
    uuid_firmware_parser (::tmxsd::uuid_pskel&);

    void
    global_tag_parser (::tmxsd::char1k_pskel&);

    void
    grammar_version_parser (::tmxsd::char64_pskel&);

    void
    n_modules_parser (::xml_schema::unsigned_int_pskel&);

    void
    is_valid_parser (::xml_schema::boolean_pskel&);

    void
    is_obsolete_parser (::xml_schema::boolean_pskel&);

    void
    comment_parser (::tmxsd::char4k_pskel&);

    void
    algorithm_parser (::tmxsd::algorithm_pskel&);

    void
    scale_set_parser (::tmxsd::scale_set_pskel&);

    void
    ext_signal_set_parser (::tmxsd::ext_signal_set_pskel&);

    void
    menu_id_parser (::tmxsd::id_pskel&);
    ...
    protected:
    ::tmxsd::id_pskel* ancestor_id_parser_;
    ::tmxsd::char1k_pskel* name_parser_;
    ::tmxsd::uuid_pskel* uuid_menu_parser_;
    ::tmxsd::uuid_pskel* uuid_firmware_parser_;
    ::tmxsd::char1k_pskel* global_tag_parser_;
    ::tmxsd::char64_pskel* grammar_version_parser_;
    ::xml_schema::unsigned_int_pskel* n_modules_parser_;
    ::xml_schema::boolean_pskel* is_valid_parser_;
    ::xml_schema::boolean_pskel* is_obsolete_parser_;
    ::tmxsd::char4k_pskel* comment_parser_;
    ::tmxsd::algorithm_pskel* algorithm_parser_;
    ::tmxsd::scale_set_pskel* scale_set_parser_;
    ::tmxsd::ext_signal_set_pskel* ext_signal_set_parser_;
    ::tmxsd::id_pskel* menu_id_parser_;
    ::tmxsd::datetime_pskel* datetime_parser_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::menu_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_MENU_PSKEL_HH
