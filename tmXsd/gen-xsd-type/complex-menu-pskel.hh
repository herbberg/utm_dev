...
namespace tmxsd
{
  class menu_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    protected:
    ::tmxsd::id_pskel* ancestor_id_;
    ::tmxsd::char1k_pskel* name_;
    ::tmxsd::uuid_pskel* uuid_menu_;
    ::tmxsd::uuid_pskel* uuid_firmware_;
    ::tmxsd::char1k_pskel* global_tag_;
    ::tmxsd::char64_pskel* grammar_version_;
    ::xml_schema::unsigned_int_pskel* n_modules_;
    ::xml_schema::boolean_pskel* is_valid_;
    ::xml_schema::boolean_pskel* is_obsolete_;
    ::tmxsd::char4k_pskel* comment_;
    ::tmxsd::algorithm_pskel* algorithm_;
    ::tmxsd::scale_set_pskel* scale_set_;
    ::tmxsd::ext_signal_set_pskel* ext_signal_set_;
    ::tmxsd::id_pskel* menu_id_;
