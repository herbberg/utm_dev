...
namespace tmxsd
{
  class object_requirement_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    ::tmxsd::char64_pskel* comparison_operator_parser_;
    ::tmxsd::real_pskel* threshold_parser_;
    ::xml_schema::int_pskel* bx_offset_parser_;
    ::tmxsd::char4k_pskel* comment_parser_;
    ::tmxsd::id_pskel* requirement_id_parser_;
