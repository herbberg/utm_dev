...
#ifndef CXX___XSD_TYPE_COMPLEX_OBJECT_REQUIREMENT_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_OBJECT_REQUIREMENT_PSKEL_HH
...
namespace tmxsd
{
  class object_requirement_pskel;
}
...
namespace tmxsd
{
  class object_requirement_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    void
    comparison_operator_parser (::tmxsd::char64_pskel&);

    void
    threshold_parser (::tmxsd::real_pskel&);

    void
    bx_offset_parser (::xml_schema::int_pskel&);

    void
    comment_parser (::tmxsd::char4k_pskel&);

    void
    requirement_id_parser (::tmxsd::id_pskel&);
    ...
    ::tmxsd::char64_pskel* type_;
    ::tmxsd::char64_pskel* comparison_operator_;
    ::tmxsd::real_pskel* threshold_;
    ::xml_schema::int_pskel* bx_offset_;
    ::tmxsd::char4k_pskel* comment_;
    ::tmxsd::id_pskel* requirement_id_;
    ::tmxsd::datetime_pskel* datetime_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::object_requirement_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_OBJECT_REQUIREMENT_PSKEL_HH
