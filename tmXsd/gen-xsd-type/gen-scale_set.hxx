...
/**
 * @file
 * @brief Generated from ../scale_set.xsd.
 */
...
#include "gen-xsd-type/complex-scale_set.hxx"
...
{
  /**
   * @name Parsing functions for the %scale_set document root.
   */
  //@{
...
{
  /**
   * @name Serialization functions for the %scale_set document root.
   */
  //@{
   ...
   */
  void
  scale_set_ (::std::ostream& os,
              const ::tmxsdtree::scale_set& x, 
   ...
   */
  void
  scale_set_ (::xercesc::XMLFormatTarget& ft,
              const ::tmxsdtree::scale_set& x, 
              const ::xml_schema::namespace_infomap& m,
              const ::std::string& e = "UTF-8",
              ::xml_schema::flags f = 0);
