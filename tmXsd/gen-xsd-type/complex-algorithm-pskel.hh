...
#ifndef CXX___XSD_TYPE_COMPLEX_ALGORITHM_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_ALGORITHM_PSKEL_HH
...
namespace tmxsd
{
  class algorithm_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    //
    void
    name_parser (::tmxsd::char1k_pskel&);

    void
    expression_parser (::tmxsd::char4k_pskel&);

    void
    index_parser (::xml_schema::unsigned_int_pskel&);

    void
    module_id_parser (::xml_schema::unsigned_int_pskel&);

    void
    module_index_parser (::xml_schema::unsigned_int_pskel&);

    void
    comment_parser (::tmxsd::char4k_pskel&);

    void
    cut_parser (::tmxsd::cut_pskel&);

    void
    object_requirement_parser (::tmxsd::object_requirement_pskel&);

    void
    external_requirement_parser (::tmxsd::external_requirement_pskel&);

    void
    algorithm_id_parser (::tmxsd::id_pskel&);
    ...
    protected:
    ::tmxsd::char1k_pskel* name_;
    ::tmxsd::char4k_pskel* expression_;
    ::xml_schema::unsigned_int_pskel* index_;
    ::xml_schema::unsigned_int_pskel* module_id_;
    ::xml_schema::unsigned_int_pskel* module_index_;
    ::tmxsd::char4k_pskel* comment_;
    ::tmxsd::cut_pskel* cut_;
    ::tmxsd::object_requirement_pskel* object_requirement_;
    ::tmxsd::external_requirement_pskel* external_requirement_;
    ::tmxsd::id_pskel* algorithm_id_;
    ::tmxsd::datetime_pskel* datetime_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::algorithm_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_ALGORITHM_PSKEL_HH
