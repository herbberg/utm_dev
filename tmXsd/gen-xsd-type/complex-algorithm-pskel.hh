...
namespace tmxsd
{
  class algorithm_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    protected:
    ::tmxsd::char1k_pskel* name_parser_;
    ::tmxsd::char4k_pskel* expression_parser_;
    ::xml_schema::unsigned_int_pskel* index_parser_;
    ::xml_schema::unsigned_int_pskel* module_id_parser_;
    ::xml_schema::unsigned_int_pskel* module_index_parser_;
    ::tmxsd::char4k_pskel* comment_parser_;
    ::tmxsd::cut_pskel* cut_parser_;
    ::tmxsd::object_requirement_pskel* object_requirement_parser_;
    ::tmxsd::external_requirement_pskel* external_requirement_parser_;
    ::tmxsd::id_pskel* algorithm_id_parser_;
