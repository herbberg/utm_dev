...
/**
 * @file
 * @brief Generated from complex-ext_signal.xsd.
 */

#ifndef CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_HXX
#define CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_HXX
...
{
  /**
   * @brief Class corresponding to the %ext_signal schema type.
   *
   * The ext_signal complex type holds information associated to EXT_SIGNAL
   * table in the CMS level-1 trigger menu database
   *
   * @nosubgrouping
   */
  class ext_signal: public ::xml_schema::type
  {
    public:
    /**
     * @name name
     ...
     * @brief Element type.
     */
    typedef ::tmxsdtree::char1k system_type;
     ...
     * @name cable
     *
     * @brief Accessor and modifier functions for the %cable
     * required element.
     */
    //@{
     ...
     * @brief Element type.
     */
    typedef ::xml_schema::unsigned_int cable_type;

    /**
     * @brief Element traits type.
     */
    typedef ::xsd::cxx::tree::traits< cable_type, char > cable_traits;
     ...
     * @brief Element type.
     */
    typedef ::xml_schema::unsigned_int channel_type;
     ...
     * @brief Element type.
     */
    typedef ::tmxsdtree::char4k description_type;
     ...
     * @brief Element type.
     */
    typedef ::tmxsdtree::char1k label_type;
     ...
     */
    void
    ext_signal_id (::std::unique_ptr< ext_signal_id_type > p);
    ...
    ::xsd::cxx::tree::one< cable_type > cable_;
...
{
  void
  operator<< (::xercesc::DOMElement&, const ext_signal&);
}
...
#endif // CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_HXX
