...
#ifndef CXX___XSD_TYPE_COMPLEX_BIN_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_BIN_PSKEL_HH
...
namespace tmxsd
{
  class bin_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    //
    void
    number_parser (::xml_schema::unsigned_int_pskel&);
    ...
    protected:
    ::xml_schema::unsigned_int_pskel* number_;
    ::tmxsd::real_pskel* minimum_;
    ::tmxsd::real_pskel* maximum_;
    ::tmxsd::id_pskel* bin_id_;
    ::tmxsd::id_pskel* scale_id_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::bin_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_BIN_PSKEL_HH
