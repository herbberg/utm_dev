...
namespace tmxsd
{
  class ext_signal_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    ::tmxsd::char1k_pskel* system_;
    ::xml_schema::unsigned_int_pskel* cable_;
    ::xml_schema::unsigned_int_pskel* channel_;
    ::tmxsd::char4k_pskel* description_;
    ::tmxsd::char1k_pskel* label_;
    ::tmxsd::id_pskel* ext_signal_id_;
