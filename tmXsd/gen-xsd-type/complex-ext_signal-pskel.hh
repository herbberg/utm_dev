...
#ifndef CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_PSKEL_HH
...
namespace tmxsd
{
  class ext_signal_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    void
    system_parser (::tmxsd::char1k_pskel&);

    void
    cable_parser (::xml_schema::unsigned_int_pskel&);

    void
    channel_parser (::xml_schema::unsigned_int_pskel&);

    void
    description_parser (::tmxsd::char4k_pskel&);

    void
    label_parser (::tmxsd::char1k_pskel&);

    void
    ext_signal_id_parser (::tmxsd::id_pskel&);
    ...
    ::tmxsd::char1k_pskel* system_parser_;
    ::xml_schema::unsigned_int_pskel* cable_parser_;
    ::xml_schema::unsigned_int_pskel* channel_parser_;
    ::tmxsd::char4k_pskel* description_parser_;
    ::tmxsd::char1k_pskel* label_parser_;
    ::tmxsd::id_pskel* ext_signal_id_parser_;
    ::tmxsd::datetime_pskel* datetime_parser_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::ext_signal_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_EXT_SIGNAL_PSKEL_HH
