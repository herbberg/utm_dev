...
/**
 * @file
 * @brief Generated from complex-cut.xsd.
 */
...
namespace tmxsdtree
{
   ...
   *
   * The cut complex type holds information associated to CUT table in the
   * CMS level-1 trigger menu database
   *
   * @nosubgrouping
   */
  class cut: public ::xml_schema::type
  {
     ...
     */
    void
    cut_id (::std::unique_ptr< cut_id_type > p);
