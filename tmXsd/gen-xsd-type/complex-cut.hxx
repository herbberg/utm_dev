...
/**
 * @file
 * @brief Generated from ../xsd-type/complex-cut.xsd.
 */

#ifndef CXX___XSD_TYPE_COMPLEX_CUT_HXX
#define CXX___XSD_TYPE_COMPLEX_CUT_HXX
...
{
  /**
   * @brief Class corresponding to the %cut schema type.
   *
   * The cut complex type holds information associated to CUT table in the CMS
   * evel-1 trigger menu database
   *
   * @nosubgrouping
   */
  class cut: public ::xml_schema::type
  {
    public:
    /**
     * @name name
     ...
     * @brief Element type.
     */
    typedef ::tmxsdtree::char4k data_type;
     ...
     * @name cut_id
     *
     * @brief Accessor and modifier functions for the %cut_id
     * optional attribute.
     */
    //@{
     ...
     */
    typedef ::tmxsdtree::id cut_id_type;

    /**
     * @brief Attribute optional container type.
     */
    typedef ::xsd::cxx::tree::optional< cut_id_type > cut_id_optional;

    /**
     * @brief Attribute traits type.
     */
    typedef ::xsd::cxx::tree::traits< cut_id_type, char > cut_id_traits;
     ...
     */
    void
    cut_id (::std::auto_ptr< cut_id_type > p);
...
#endif // CXX___XSD_TYPE_COMPLEX_CUT_HXX
