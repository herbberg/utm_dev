...
#ifndef CXX___XSD_TYPE_COMPLEX_CUT_PSKEL_HH
#define CXX___XSD_TYPE_COMPLEX_CUT_PSKEL_HH
...
namespace tmxsd
{
  class cut_pskel: public virtual ::xml_schema::complex_content
  {
    public:
    ...
    void
    data_parser (::tmxsd::char4k_pskel&);

    void
    comment_parser (::tmxsd::char4k_pskel&);

    void
    cut_id_parser (::tmxsd::id_pskel&);
    ...
    ::tmxsd::char64_pskel* object_;
    ::tmxsd::char64_pskel* type_;
    ::tmxsd::real_pskel* minimum_;
    ::tmxsd::real_pskel* maximum_;
    ::tmxsd::char4k_pskel* data_;
    ::tmxsd::char4k_pskel* comment_;
    ::tmxsd::id_pskel* cut_id_;
    ::tmxsd::datetime_pskel* datetime_;

    protected:
    struct v_state_descr_
    {
      void (::tmxsd::cut_pskel::*func) (
        unsigned long&,
        unsigned long&,
        const ::xml_schema::ro_string&,
        const ::xml_schema::ro_string&,
...
#endif // CXX___XSD_TYPE_COMPLEX_CUT_PSKEL_HH
