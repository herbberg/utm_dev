...
/**
 * @file
 * @brief Generated from complex-scale_set.xsd.
 */

#ifndef CXX___XSD_TYPE_COMPLEX_SCALE_SET_HXX
#define CXX___XSD_TYPE_COMPLEX_SCALE_SET_HXX
...
{
  /**
   * @brief Class corresponding to the %scale_set schema type.
   *
   * The scale_set complex type holds information associated to SCALE_SET
   * table in the CMS level-1 trigger menu database
   *
   * @nosubgrouping
   */
  class scale_set: public ::xml_schema::type
  {
    public:
    /**
     * @name name
     ...
     * @brief Element type.
     */
    typedef ::tmxsdtree::scale scale_type;

    /**
     * @brief Element sequence container type.
     */
    typedef ::xsd::cxx::tree::sequence< scale_type > scale_sequence;

    /**
     * @brief Element iterator type.
     */
    typedef scale_sequence::iterator scale_iterator;

    /**
     * @brief Element constant iterator type.
     */
    typedef scale_sequence::const_iterator scale_const_iterator;
     ...
     * @name scale_set_id
     *
     * @brief Accessor and modifier functions for the %scale_set_id
     * optional attribute.
     */
    //@{
     ...
     */
    typedef ::tmxsdtree::id scale_set_id_type;

    /**
     * @brief Attribute optional container type.
     */
    typedef ::xsd::cxx::tree::optional< scale_set_id_type > scale_set_id_optional;

    /**
     * @brief Attribute traits type.
     */
    typedef ::xsd::cxx::tree::traits< scale_set_id_type, char > scale_set_id_traits;
     ...
     */
    void
    scale_set_id (::std::unique_ptr< scale_set_id_type > p);
    ...
    scale_sequence scale_;
    scale_set_id_optional scale_set_id_;
...
{
  void
  operator<< (::xercesc::DOMElement&, const scale_set&);
}
...
#endif // CXX___XSD_TYPE_COMPLEX_SCALE_SET_HXX
